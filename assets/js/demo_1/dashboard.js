...
(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var data_1_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_1_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));

      var data_2_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_2_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));

      var data_3_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_3_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));

      var data_4_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_4_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));
      var areaData = {
        labels: ["Jan 1", "Jan 7", "Jan 14", "Jan 21", "Jan 28", "Feb 4", "Feb 11", "Feb 18"],
        datasets: [{
          label: 'Your Water Usage',
          data: data_1_1,
          borderColor: infoColor,
          backgroundColor: gradientStrokeFill_1,
          borderWidth: 2
        }, {
          label: 'Optimal Water Usage ',
          data: data_1_2,
    ...
    if ($('#sales2-statistics-overview').length) {
      var sales2ChartCanvas = $("#sales2-statistics-overview").get(0).getContext("2d");
      var gradientStrokeFill_1 = sales2ChartCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = sales2ChartCanvas.createLinearGradient(0, 0, 0, 400);
      gradientStrokeFill_2.addColorStop(1, 'rgba(255, 255, 255, 0.01)');
      gradientStrokeFill_2.addColorStop(0, '#14c671');
      var data_1_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_1_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));
      ...
      var areaData = {
        labels: ["Jan 1", "Jan 7", "Jan 14", "Jan 21", "Jan 28", "Feb 4", "Feb 11", "Feb 18"],
        datasets: [{
          label: 'Your Fertilizer Usage',
          data: data_1_1,
          borderColor: infoColor,
          backgroundColor: gradientStrokeFill_1,
          borderWidth: 2
        }, {
          label: 'Optimal Fertilizer Usage ',
          data: data_1_2,
          borderColor: successColor,
          backgroundColor: gradientStrokeFill_2,
          borderWidth: 2
      ...
      var sales2Chart = new Chart(sales2ChartCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
      });
      document.getElementById('sales2-statistics-legend').innerHTML = sales2Chart.generateLegend();

      $("#sales2-statistics_switch_1").click(function () {
        var data = sales2Chart.data;
        data.datasets[0].data = data_1_1;
        data.datasets[1].data = data_1_2;
        sales2Chart.update();
      });
      $("#sales2-statistics_switch_2").click(function () {
        var data = sales2Chart.data;
        data.datasets[0].data = data_2_1;
        data.datasets[1].data = data_2_2;
        sales2Chart.update();
      });
      $("#sales2-statistics_switch_3").click(function () {
        var data = sales2Chart.data;
        data.datasets[0].data = data_3_1;
        data.datasets[1].data = data_3_2;
        sales2Chart.update();
      });
      $("#sales2-statistics_switch_4").click(function () {
        var data = sales2Chart.data;
        data.datasets[0].data = data_4_1;
        data.datasets[1].data = data_4_2;
        sales2Chart.update();
    ...
    if ($('#sales3-statistics-overview').length) {
      var sales3ChartCanvas = $("#sales3-statistics-overview").get(0).getContext("2d");
      var gradientStrokeFill_1 = sales3ChartCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = sales3ChartCanvas.createLinearGradient(0, 0, 0, 400);
      gradientStrokeFill_2.addColorStop(1, 'rgba(255, 255, 255, 0.01)');
      gradientStrokeFill_2.addColorStop(0, '#14c671');
      var data_1_1 = Array.from({ length: 11 }, () => getRandomInt(50, 200));
      var data_1_2 = Array.from({ length: 12 }, () => getRandomInt(0, 150));
      ...
      var areaData = {
        labels: ["Jan 1", "Jan 7", "Jan 14", "Jan 21", "Jan 28", "Feb 4", "Feb 11", "Feb 18"],
        datasets: [{
          label: 'Your Pesticide Usage',
          data: data_1_1,
          borderColor: infoColor,
          backgroundColor: gradientStrokeFill_1,
          borderWidth: 2
        }, {
          label: 'Optimal Pesticide Usage ',
          data: data_1_2,
          borderColor: successColor,
          backgroundColor: gradientStrokeFill_2,
          borderWidth: 2
      ...
      var sales3Chart = new Chart(sales3ChartCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
      });
      document.getElementById('sales3-statistics-legend').innerHTML = sales3Chart.generateLegend();

      $("#sales3-statistics_switch_1").click(function () {
        var data = sales3Chart.data;
        data.datasets[0].data = data_1_1;
        data.datasets[1].data = data_1_2;
        sales3Chart.update();
      });
      $("#sales3-statistics_switch_2").click(function () {
        var data = sales3Chart.data;
        data.datasets[0].data = data_2_1;
        data.datasets[1].data = data_2_2;
        sales3Chart.update();
      });
      $("#sales3-statistics_switch_3").click(function () {
        var data = sales3Chart.data;
        data.datasets[0].data = data_3_1;
        data.datasets[1].data = data_3_2;
        sales3Chart.update();
      });
      $("#sales3-statistics_switch_4").click(function () {
        var data = sales3Chart.data;
        data.datasets[0].data = data_4_1;
        data.datasets[1].data = data_4_2;
        sales3Chart.update();
